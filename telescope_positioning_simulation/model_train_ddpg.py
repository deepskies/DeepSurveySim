...
model = DDPG("MlpPolicy", env, **hyperparams, tensorboard_log=log_dir)
...
i = 0
for i in range(400):
    model.learn(total_timesteps=TIMESTEPS, reset_num_timesteps=False, tb_log_name="DDPG_g", callback=tensorboard_callback)
    model.save(f"{models_dir}/{TIMESTEPS*i}")


#model.save(f"{models_dir}/ddpg_u_survey_model")
writer.close()
