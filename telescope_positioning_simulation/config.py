...
SAC_HYPERPARAMS = {
    ...
    "initial_alpha": tune.grid_search([0.1]),
    "target_entropy": "auto",
    "n_step": 1,
    ...
    "grad_clip": tune.grid_search([0.1]),
    "optimization_config": {
        "actor_learning_rate": tune.grid_search([0.0003]),
        "critic_learning_rate": tune.grid_search([0.0003]),
        "entropy_learning_rate": tune.grid_search([0.0003])
    },
...
DDPG_HYPERPARAMS = {
    ...
    "actor_hiddens": tune.grid_search([[256]]),
    "actor_hidden_activation": "relu",
    "critic_hiddens": tune.grid_search([[256, 256]]),
    "critic_hidden_activation": "relu",
    "n_step": 1,
    "critic_lr": tune.grid_search([0.001]),
    "actor_lr": tune.grid_search([0.001]),
