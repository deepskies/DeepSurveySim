...
def test_default_init():
    ...
    survey = Survey(
        survey_config=ReadConfig(survey=True)(), observatory_config=obs_config
    )
...
def test_dont_stop_me():
    ...
    survey_config["stopping"] = {
        "timestep": 6,
        "random_var": {"value": 42, "lesser": True},
    }
...
def test_stop_me():
    ...
    survey_config["stopping"] = {
        "timestep": 6,
        "random_var": {"value": 42, "lesser": False},
    }
...
def test_all_gather_variables():
    ...
    for key in observation_keys:
        if key != "mjd":
            ...
            assert len(observation[key]) == expected_shape
